...
- Deep-linked team routes initialize the drawer open immediately and render the selected team detail content before hydration through `TeamDetailContent`, which is shared with `TeamDetailDrawer`.
